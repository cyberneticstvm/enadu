                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{ $user->name }}" placeholder="Staff Name">
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="mobile" maxlength="10" value="{{ $user->mobile }}" placeholder="Mobile Number">
                                        </div>
                                        @error('mobile')
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="password" maxlength="10" placeholder="******">
                                        </div>
                                        @error('password')
